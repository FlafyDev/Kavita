...
export class UserPreferencesComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    forkJoin({
      ...
      this.settingsForm.addControl(
        'bookReaderDarkMode',
        new FormControl(this.user.preferences.bookReaderDarkMode, [])
      );
      this.settingsForm.addControl(
  ...
  resetForm() {
    ...
    this.settingsForm
      .get('bookReaderDarkMode')
      ?.setValue(this.user.preferences.bookReaderDarkMode);
    this.settingsForm
